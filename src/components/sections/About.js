  ...
  return (
    <Section id="about">
      <Container>
        ...
        <SubText style={{}}>
        <b style={{color:'#aeff00',
        fontFamily: 'flegrei sans-serif',fontWeight: '400',fontStyle: 'normal'}}>SPACE BABIEZ NFT</b> | exploring the limits of education through blockchain |
        </SubText>
    ...
    <Suspense fallback={<Loading />}>
          ...
          <br/><br/><br/><br/> <b style={{color:'#ff0066 ',marginLeft:'0%',marginTop:'-5%',fontSize:'25px',
...
Babiez University.
        ...
        <b style={{color:'#ff0066',marginLeft:'0%',fontSize:'30px',
        fontFamily: 'flegrei',fontWeight: '400',fontStyle: 'normal'
